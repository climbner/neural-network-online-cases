安徽大学计算机学院《神经网络》配套线上实践
PyTorch 官方示例库 是 PyTorch 官方维护的深度学习示例项目，涵盖基础神经网络、卷积神经网络、循环神经网络、生成对抗网络、图神经网络等多个典型模型。该项目代码结构清晰、案例丰富，适合学生通过运行和修改示例代码，理解神经网络模型的构建、训练、测试与优化流程，作为课程入门实验和基础实践的重要资源。
# PyTorch Examples
